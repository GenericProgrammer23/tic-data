...
def extract_rates(
    ...
    group_ids, providers, provider_diagnostics = _find_provider_matches(path, organization)
    rates, truncated, rate_diagnostics = _find_rates(path, organization, group_ids, filters)
    diagnostics = {
